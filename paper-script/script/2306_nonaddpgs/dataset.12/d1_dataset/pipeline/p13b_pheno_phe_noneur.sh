...
python -m projects_py.genetics.dataset.phenotype \
	--case \
	--fout ${ddata_tmp}/case_noneur.phenotypes \
...
csvjoin -c1,1 -t -I -v ${ddata_tmp}/sex_age_pc_noneur.cov ${ddata_tmp}/case_noneur.phenotypes |
	csvformat -T >${ddata}/ukb_imp_noneur.phe
